...
class TiiLIDARMultiModalDatasetSchema(SegmentationDatasetSchema):
    """
    Schema for configuring the TiiLIDARMultiModal dataset. 
    """
    dem_dir = fields.String(
        missing="/", description="Directory containing the DEM files", example="./data/DEM_Files/"
    ) 