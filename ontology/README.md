...
Each run is semantically enriched using MLDCAT-AP and FAIR-EO specific vocabularies. Their metadata can be found in the [runs.ttl](ontology/metadata/runs.ttl) file. 
